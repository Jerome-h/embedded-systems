...
Included files are:
  ...
  screenshot       -    Screenshot showing output after analysing the 6 example files included
  screenshot2      -    Screenshot showing output after analysing 99 example files
